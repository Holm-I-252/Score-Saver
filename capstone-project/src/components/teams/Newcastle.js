...
class Newcastle extends Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  async getScore() {
    ...
    this.state.data.forEach((element) => {
      if (
        element.homeTeam.name === "Newcastle United FC" ||
        element.awayTeam.name === "Newcastle United FC"
      ) {
    ...
    scorers.data.scorers.forEach((element) => {
      if (element.team.name === "Newcastle United FC") {
